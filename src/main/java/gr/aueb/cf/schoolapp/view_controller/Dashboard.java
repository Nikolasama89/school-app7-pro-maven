...
//		});
		...
		lbl_oftenQuestions.setFont(new Font("Tahoma", Font.BOLD, 13));
		...
		lbl_support.setFont(new Font("Tahoma", Font.BOLD, 13));
		...
		lbl_teachersView.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lbl_teachersView.setBackground(Color.WHITE);
		lbl_teachersView.setBounds(20, 68, 142, 31);
		...
		lbl_teacherInsert.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Main.getDashboard().setEnabled(false);
				Main.getInsertTeacherPageClass().setVisible(true);
			}
		});
		
		lbl_teacherInsert.setForeground(Color.WHITE);
		lbl_teacherInsert.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lbl_teacherInsert.setBackground(Color.WHITE);
		lbl_teacherInsert.setBounds(20, 97, 142, 31);
		leftPanel.add(lbl_teacherInsert);
		
		JLabel lblQualityTeaching = new JLabel("Ποιότητα στην Εκπαίδευση");
		lblQualityTeaching.setFont(new Font("Tahoma", Font.PLAIN, 22));
		lblQualityTeaching.setBounds(345, 81, 390, 49);
		contentPane_1.add(lblQualityTeaching);
		
		JLabel lblNewLabel = new JLabel("Προβολή Μητρώου Εκπαιδευτών");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel.setBounds(261, 151, 228, 18);
		contentPane_1.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Προβολή Μητρώου Εγγεγραμμένων Εκπαιδευτών στο Μητρώο του Coding Factory");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel_1.setBounds(261, 170, 430, 18);
		...
		btnInsertTeacher.setBounds(261, 282, 94, 31);
