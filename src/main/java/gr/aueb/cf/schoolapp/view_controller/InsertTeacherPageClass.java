...
public class InsertTeacherPageClass extends JFrame {
	...
	public InsertTeacherPageClass() {
		...
		govImage.setIcon(new ImageIcon(InsertTeacherPageClass.class.getResource("/images/gov_logo_small.png")));
		...
		vatText.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				errorVat.setText(inputVat.isEmpty() ? "Το ΑΦΜ είναι υποχρεωτικό" : "");
		...
		closeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Main.getInsertTeacherPageClass().setVisible(false);
		...
		errorVat.setBounds(91, 236, 260, 29);
