...
public class Main {
	...
	private static final InsertTeacherPageClass insertTeacherPageClass = new InsertTeacherPageClass();
 	/**
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					insertTeacherPageClass.setVisible(false);
					insertTeacherPageClass.setLocationRelativeTo(null);
	...
	public static InsertTeacherPageClass getInsertTeacherPageClass() {
		return insertTeacherPageClass;
	}
